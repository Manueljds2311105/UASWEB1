<div class="main-content">
    <div class="topbar">
        <div class="topbar-left">
            <h4><i class="fas fa-home"></i> Jalanin</h4>
        </div>
    ...
    <div class="content-area">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p>Selamat datang di <strong>Sistem Manajemen Sewa Kendaraan</strong>. Anda login sebagai <strong><?= isset($_SESSION['role']) ? ucfirst($_SESSION['role']) : 'User' ?></strong>.</p>
                <p>Sistem ini membantu Anda mengelola data kendaraan, pelanggan, dan transaksi sewa dengan mudah dan efisien.</p>
            </div>
        </div>
