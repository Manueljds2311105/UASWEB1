                ...
                <form method="POST" action="<?= BASE_URL ?>kendaraan/create" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="tahun_produksi" class="form-control" min="1990" max="<?= date('Y') ?>" required>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="harga_sewa_perhari" class="form-control" required onkeyup="formatRupiah(this)">
                        </div>
                    </div>
